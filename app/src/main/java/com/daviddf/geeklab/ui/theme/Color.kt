...
val CardNotificaciones = Color(0xFF9FFFFF)
val CardBateria = Color(0xFFA5FFC9)
val CardInformacion = Color(0xFFD4AAFF)
val CardAplicaciones = Color(0xFFFFFFA5)

val TextNotificaciones = Color(0xFF004D4D)
val TextBateria = Color(0xFF004D21)
